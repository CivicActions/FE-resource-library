...
- See existing documentation `.mdx` files for an example of how to format the file.
...
## Components, Hooks, and other reusable code examples

_More information coming soon._

## Workflow

- Whether you have an idea for a new general documetation or a component or hook you want to share, create an issue for your idea and follow the issue guidelines for creating a new contribution.
...
- Once your branch is merged it will be available on the github pages instance after the build tasks completes.
